...
body {
  background: #DCDDDF url(../assets/img/7AF2Qzt.png);
  color: #000;
  font: 14px Arial;
  margin: 0 auto;
  padding: 0;
...
<div class="container">
  ...
  <section id="content">
    <?= form_open(site_url('karir/register')) ?>
      <h1>Registrasi</h1>
      ...
      <div class="form-group <?= form_error('email') ? 'has-error' : '' ?>">
        <input type="text" placeholder="Email" required="" id="email" name="email" value="<?= set_value('email') ?>" />
        <?php if (form_error('email')): ?>
            <span class="help-block"><?= form_error('email') ?></span>
        <?php endif ?>
      </div>
      <div class="form-group <?= form_error('password') ? 'has-error' : '' ?>">
        <input type="password" placeholder="Kata Sandi" required="" id="password" name="password" />
        <?php if (form_error('password')): ?>
            <span class="help-block"><?= form_error('password') ?></span>
        <?php endif ?>
      </div>
      <div class="form-group <?= form_error('password_confirm') ? 'has-error' : '' ?>">
        <input type="password" placeholder="Konfirmasi Kata Sandi" required="" id="password_confirm" name="password_confirm" />
