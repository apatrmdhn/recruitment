                        ...
                        <tr>
                            ...
                            <td class="fit">
                                <?php if ($r->status === 'divisi_submit'): ?>
                                    <a href="<?= site_url('dashboard/hrd/fpk/approve?fpk_id='.$r->fpk_id) ?>"
                                        class="btn btn-success btn-sm">
                                        <i class="glyphicon glyphicon-check"></i>
                                        Setuju
                                    </a>
                                    <a href="<?= site_url('dashboard/hrd/fpk/reject?fpk_id='.$r->fpk_id) ?>"
                                        class="btn btn-warning btn-sm">
                                        <i class="glyphicon glyphicon-remove"></i>
                                        Tolak
                                    </a>
                                <?php endif ?>
                                <a href="<?= site_url('dashboard/hrd/fpk/detail') ?>?fpk_id=<?= $r->fpk_id ?>"
