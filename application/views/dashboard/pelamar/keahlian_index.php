...
<div class="row" style="padding-bottom: 10px;">
    <div class="col-xs-12">
        <a href="<?= site_url('dashboard/pelamar/keahlian/add') ?>"
                ...
                <?php if (count($keahlian)): ?>
                    ...
                    <?php foreach ($keahlian as $r): ?>
                        <tr>
                            ...
                            <td><?= $r->deskripsi ?></td>
                            <td class="fit">
                                <a href="<?= site_url('dashboard/pelamar/keahlian/edit') ?>?keahlian_id=<?= $r->keahlian_id ?>"
                                    class="btn btn-default btn-sm" title="Edit">
                                    <i class="glyphicon glyphicon-pencil"></i>
                                </a>
                                <a href="javascript:confirmRedirect('Anda yakin ingin menghapus data: <?= $r->nama ?> ?', '<?= site_url('dashboard/pelamar/keahlian/delete') ?>?keahlian_id=<?= $r->keahlian_id ?>')"
