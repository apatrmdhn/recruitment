...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= form_open_multipart(site_url('dashboard/pelamar/pengalaman_kerja/edit?pengalaman_id='.$pengalaman->pengalaman_id), ['class' => 'panel panel-default']) ?>
            ...
            <div class="panel-body">
                ...
                <div class="form-group <?= form_error('nama_perusahaan') ? 'has-error' : '' ?>">
                    ...
                    <input name="nama_perusahaan" type="text" class="form-control" value="<?= $pengalaman->nama_perusahaan ?>" />
                </div>

                <div class="form-group <?= form_error('tanggal_masuk') ? 'has-error' : '' ?>">
                    <label for="tanggal_masuk" class="control-label">*Tanggal Masuk</label>
                    <input name="tanggal_masuk" type="text" data-field-role="date" class="form-control" value="<?= $pengalaman->tanggal_masuk ?>" />
                </div>
                ...
                <div class="form-group <?= form_error('tanggal_keluar') ? 'has-error' : '' ?>">
                    ...
                    <input name="tanggal_keluar" type="text" data-field-role="date" class="form-control" value="<?= $pengalaman->tanggal_keluar ?>" />
                </div>

                <div class="form-group <?= form_error('jabatan') ? 'has-error' : '' ?>">
                    <label for="jabatan" class="control-label">*Jabatan</label>
                    <input name="jabatan" type="text" class="form-control" value="<?= $pengalaman->jabatan ?>" />
                </div>
