    ...
    <div class="col-xs-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                <?php if ($fpk->status === 'hrd_approve'): ?>
                    <a href="<?= site_url('dashboard/dirut/fpk/approve?fpk_id='.$fpk->fpk_id) ?>"
                        class="btn btn-success">
                        <i class="glyphicon glyphicon-check"></i>
                        Setuju
                    </a>
                    <a href="<?= site_url('dashboard/dirut/fpk/reject?fpk_id='.$fpk->fpk_id) ?>"
                        class="btn btn-warning">
                        <i class="glyphicon glyphicon-remove"></i>
                        Tolak
                    </a>
                <?php endif ?>
                <a href="<?= site_url('dashboard/dirut/fpk') ?>"
