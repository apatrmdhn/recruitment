...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= form_open(site_url('dashboard/admin/accounts/add'), ['class' => 'panel panel-default']) ?>
            ...
            <div class="panel-body">
                ...
                <div class="form-group <?= form_error('hak_akses') ? 'has-error' : '' ?>">
                    ...
                    <?= form_dropdown('hak_akses', $arr_hak_akses, set_value('hak_akses'), 'class="form-control"') ?>
                ...
                <div class="form-group <?= form_error('password_confirm') ? 'has-error' : '' ?>">
                    ...
                    <input name="password_confirm" type="password" class="form-control" value="<?= set_value('password_confirm') ?>" />
